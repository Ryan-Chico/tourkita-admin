...
const ARUploadModal = ({ markers, arAssets, assetToEdit, onClose }) => {
    ...
    useEffect(() => {
        if (isEditMode) {
            setFormData({
                location: assetToEdit.locationName || assetToEdit.id,
