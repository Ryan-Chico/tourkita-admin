...
// ---------------- HARDCODED CLOUDINARY SIGNED UPLOAD ----------------
const CLOUDINARY_CLOUD_NAME = "dupjdmjha";
const CLOUDINARY_API_KEY = "528165198938892";
const CLOUDINARY_TIMESTAMP = "1695888000"; // Replace with your generated timestamp
const CLOUDINARY_SIGNATURE = "YOUR_GENERATED_SIGNATURE"; // Replace with the signature from generateSignature.js
// -------------------------------------------------------------------
...
const ARUploadModal = ({ markers, onClose }) => {
    ...
    const uploadToCloudinary = async (file, type) => {
        try {
            ...
            data.append("timestamp", CLOUDINARY_TIMESTAMP);
            data.append("signature", CLOUDINARY_SIGNATURE);
            data.append("folder", "ar_assets");
