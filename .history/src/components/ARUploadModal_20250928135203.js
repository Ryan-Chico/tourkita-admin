...
const CLOUDINARY_API_KEY = "825334771165414";
const CLOUDINARY_SIGNATURE = "YOUR_HARDCODED_SIGNATURE";
const CLOUDINARY_TIMESTAMP = "YOUR_HARDCODED_TIMESTAMP";
// ---------------------------------------------------
...
const ARUploadModal = ({ markers, onClose }) => {
    ...
    const uploadToCloudinary = async (file, type) => {
        try {
            ...
            formDataObj.append("api_key", CLOUDINARY_API_KEY);
            formDataObj.append("timestamp", CLOUDINARY_TIMESTAMP);
            formDataObj.append("signature", CLOUDINARY_SIGNATURE);
            formDataObj.append("folder", "ar_assets");
            formDataObj.append("resource_type", resourceType);
