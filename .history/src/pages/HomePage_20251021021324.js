...
const HomePage = () => {
    ...
    return (
      ...
      // src/pages/HomePage.jsx
            ...
            // ... inside your return statement, find the .info-slides-section

            <section className="info-slides-section fade-in-up">
                <h2>Why Choose TourKita?</h2>

                {/* === START: REPLACE THE ENTIRE .info-slides DIV WITH THIS === */}
                <div className="info-slides">
                    {/* Card 1: Augmented Reality */}
