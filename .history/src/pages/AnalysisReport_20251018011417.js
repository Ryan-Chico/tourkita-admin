...
const AnalysisReport = () => {
    ...
    const genderChartData = useMemo(() => {
        // This function would contain the logic for grouping gender data
        // For brevity, the full implementation is not repeated, but it should be here.
        return []; // Replace with actual memoized logic
    }, [filteredUsers, filter, selectedYear]);

    const userTypeChartData = useMemo(() => {
         // This function would contain the logic for grouping user type data
        return []; // Replace with actual memoized logic
    }, [filteredUsers, filter, selectedYear]);

    const ageGroupChartData = useMemo(() => {
         // This function would contain the logic for grouping age data
        return { data: [], ageGroups: [] }; // Replace with actual memoized logic
    }, [filteredUsers, filter, selectedYear]);
