...
// ✨ Import the FiLoader icon for our spinner
...
const ArManagement = () => {
    ...
    // ... (All data fetching and other handler functions remain the same)
                            ...
                            <div className="marker-card" key={asset.id} onClick={() => deletingId !== asset.id && handlePreviewClick(asset)}>
                                {deletingId === asset.id && (
                                    <div className="card-loading-overlay">
                                        {/* ✅ Use the FiLoader icon and give it a "spinner" class */}
