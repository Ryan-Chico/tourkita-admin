...
const ArManagement = () => {
    ...
    // ✨ Modified Edit handler to include event propagation stop
    ...
    // ✨ Modified Delete handler to include event propagation stop
                        ...
                        {arAssets.map((asset) => (
                            ...
                            <div className="marker-card" key={asset.id} onClick={() => handlePreviewClick(asset)}>
                                ...
                                <div className="card-actions">
                                    {/* ✅ Buttons now stop propagation and have no icons */}
