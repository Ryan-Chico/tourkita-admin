        ...
        <div className="dashboard-main">
            ...
            <div className="dashboard-section">
                <div className="ar-header">
                    ...
                    <p className="ar-subtitle">Manage 3D models and content for locations in Intramuros.</p>
                </div>
                ...
                {isLoading ? (
                    ...
                    // ✅ CHANGED: Use markers-list to apply grid styling
                        ...
                        {arAssets.map((asset) => (
                            <div className="marker-card" key={asset.id}>
                                ...
                                <div className="marker-card-content">
                                    {/* ✅ CHANGED: Use h4 to match CSS */}
                                    <h4>{asset.id}</h4>
                                    <p>Physical Width: {asset.physicalWidth}m</p>
                                </div>
                                {/* ✅ CHANGED: Use card-actions to style buttons */}
