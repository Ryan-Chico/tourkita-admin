...
const HomePage = () => {
    ...
    // Effect for scroll fade-in animations
    useEffect(() => {
    ...
    return (
        <div className="home-wrapper">
            ...
            <header className={`home-header ${isScrolled ? 'scrolled' : ''} ${isMenuOpen ? 'menu-open' : ''}`}>
                ...
                <nav className={`header-right ${isMenuOpen ? 'open' : ''}`}>
                    <button onClick={() => { navigate("/faqs"); setIsMenuOpen(false); }} className="header-link">FAQ</button>
                    <button onClick={() => { navigate("/privacy"); setIsMenuOpen(false); }} className="header-link">Privacy Policy</button>
                    <button className="header-button" onClick={() => { navigate('/login'); setIsMenuOpen(false); }}>Admin Login</button>
                </nav>
