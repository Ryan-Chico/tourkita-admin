...
const ArManagement = () => {
    ...
    // ✨ New state to track the ID of the asset being deleted
    ...
    const handleDeleteClick = async (e, asset) => {
        ...
        // ✅ Set the deleting state for this specific card
        ...
        try {
            ...
            // ✅ Clear the deleting state when done (success or failure)
            setDeletingId(null);
        }
    };
