...
const ArManagement = () => {
    ...
    const [activeCategory, setActiveCategory] = useState("All"); // Renamed for clarity
        ...
        <div className={showUploadForm ? "dashboard-main modal-is-open" : "dashboard-main"}>
            <div className="dashboard-section">
                ...
                <div className="top-controls">
                    {/* --- UPDATED: Replaced filter buttons with the new tab UI --- */}
                    <div className="mtab-buttons">
                        <button
                            className={`mtab ${activeCategory === "All" ? "active" : ""}`}
                            onClick={() => setActiveCategory("All")}
                        >
                            All
                        </button>
                        <button
                            className={`mtab ${activeCategory === "Building" ? "active" : ""}`}
                            onClick={() => setActiveCategory("Building")}
                        >
                            Buildings
                        </button>
                        <button
                            className={`mtab ${activeCategory === "Relics/Artifacts" ? "active" : ""}`}
                            onClick={() => setActiveCategory("Relics/Artifacts")}
                        >
                            Relics/Artifacts
                        </button>
                    </div>
