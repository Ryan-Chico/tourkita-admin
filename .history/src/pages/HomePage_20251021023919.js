                ...
                <div className="footer-main">
                    ...
                    <div className="footer-column footer-connect">
                        ...
                        <div className="social-links">
                            <a href="#" aria-label="Facebook"><svg viewBox="0 0 24 24"><path d="M12 2.04C6.5 2.04 2 6.53 2 12s4.5 9.96 10 9.96c5.5 0 10-4.46 10-9.96S17.5 2.04 12 2.04zm3.5 8.44h-2.1v7.52h-3.03V10.48H9.13V8.1h1.24V6.63c0-1.42.66-2.2 2.22-2.2h1.93v2.38h-1.42c-.59 0-.66.28-.66.66v.63h2.1l-.23 2.38z" /></svg></a>
                            <a href="#" aria-label="Twitter"><svg viewBox="0 0 24 24"><path d="M22 5.8a8.49 8.49 0 0 1-2.36.64 4.13 4.13 0 0 0 1.81-2.27 8.21 8.21 0 0 1-2.61 1 4.1 4.1 0 0 0-7 3.74 11.64 11.64 0 0 1-8.45-4.29 4.1 4.1 0 0 0 1.27 5.49A4.09 4.09 0 0 1 2 9.4v.05a4.1 4.1 0 0 0 3.3 4.03 4.1 4.1 0 0 1-1.86.07 4.1 4.1 0 0 0 3.83 2.84A8.22 8.22 0 0 1 3 18.34a11.59 11.59 0 0 0 6.29 1.84" /></svg></a>
                            <a href="#" aria-label="Instagram"><svg viewBox="0 0 24 24"><path d="M12 2c-2.72 0-3.05.01-4.12.06a4.87 4.87 0 0 0-3.44 3.44c-.05 1.07-.06 1.4-.06 4.12s.01 3.05.06 4.12a4.87 4.87 0 0 0 3.44 3.44c1.07.05 1.4.06 4.12.06s3.05-.01 4.12-.06a4.87 4.87 0 0 0 3.44-3.44c.05-1.07.06-1.4.06-4.12s-.01-3.05-.06-4.12a4.87 4.87 0 0 0-3.44-3.44C15.05 2.01 14.72 2 12 2zm0 1.8a9.6 9.6 0 0 1 4.08.06 3.07 3.07 0 0 1 2.26 2.26c.05.99.06 1.3.06 4.08s-.01 3.09-.06 4.08a3.07 3.07 0 0 1-2.26 2.26c-.99.05-1.3.06-4.08.06s-3.09-.01-4.08-.06a3.07 3.07 0 0 1-2.26-2.26c-.05-.99-.06-1.3-.06-4.08s.01-3.09.06-4.08A3.07 3.07 0 0 1 7.92 3.86c.99-.05 1.3-.06 4.08-.06zM12 6.8a5.2 5.2 0 1 0 0 10.4 5.2 5.2 0 0 0 0-10.4zm0 8.6a3.4 3.4 0 1 1 0-6.8 3.4 3.4 0 0 1 0 6.8zm6.22-8.3a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z" /></svg></a>
                        </div>
                    </div>
                </div>
