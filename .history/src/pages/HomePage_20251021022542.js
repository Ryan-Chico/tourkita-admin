                    ...
                    <div className="info-card ar fade-in-left" style={{ animationDelay: '0.2s' }}>
                        <div className="info-icon">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-2.474-1.359-2.064L5.57 16.61a7.5 7.5 0 01-2.225-5.32c0-4.142 3.358-7.5 7.5-7.5s7.5 3.358 7.5 7.5c0 1.25-.305 2.44-.845 3.5l-2.51 5.424-1.359-2.064.569 2.474-2.51-2.225z" />
                            </svg>
                        </div>
