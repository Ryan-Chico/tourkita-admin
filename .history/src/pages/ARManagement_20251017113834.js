...
const ArManagement = () => {
    ...
    const handleDeleteClick = async (e, asset) => {
        ...
        try {
            ...
            if (markerToUpdate) {
                await updateDoc(doc(db, "markers", markerToUpdate.id), {
            ...
            // STEP 3: After DB success, safely delete files from Storage
            // ✅ FIX: This filters out any null, undefined, or empty string URLs to prevent the crash
